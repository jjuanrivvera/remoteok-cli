// Package output renders Remote OK job JSON in table/json/yaml/csv/id. One renderer serves
...
// preferredOrder lists Remote OK job fields that should lead a table when present, before
// the rest fall back to alphabetical. Deterministic ordering is required by GOAL.md §11.
var preferredOrder = []string{
	"id", "position", "company", "tags", "location",
	"salary_min", "salary_max", "date", "url", "apply_url", "slug", "epoch",
}
