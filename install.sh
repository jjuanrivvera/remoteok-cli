#!/bin/sh
# remoteok installer for macOS and Linux.
#
...
#   REMOTEOK_VERSION=v1.2.3        pin a version (default: the latest release)
...
REPO="jjuanrivvera/remoteok-cli"
BINARY="remoteok"
VERSION=""
...
if [ -z "$VERSION" ]; then
  ...
  [ -n "$VERSION" ] || die "could not determine the latest release; set REMOTEOK_VERSION"
fi
